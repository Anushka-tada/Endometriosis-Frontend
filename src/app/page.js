      ...
      <div style={{ backgroundColor: "rgba(250, 250, 250, 1)" }}>
        ...
        <div className="homeHeroSection">
          <div className="container">
            <div className="row">
              <div className="col-lg-6 col-12 pt-5 mt-5 ps-3  order-lg-1 order-2">
                <div>
                  ...
                  <p className="paraPrimary me-5 pe-3 mb-5 text-sm-start text-center">
                    Hello, I’m{" "}
                  ...
                  <div className="d-flex gap-sm-4 gap-2 pt-5 mb-5">
        ...
        <div className="container py-5 mb-3">
          <div className="row">
            <div className="col-md-3 col-6 p-2">
              <div
                className="text-center p-md-5 p-2 homeCard boxShadow"
        ...
        <div className="container py-5">
          ...
          <div className="row pt-4">
            <div className="col-md-6 col-12 p-2">
              <div
                className="bg-white boxShadow p-4 h-100"
        ...
        <div className="container mt-3">
          ...
          <p className="medium-text text-center mx-5 pb-5 mb-3">
            ...
            <Slider {...settings}>
              {EndometriosSteps.map((step, index) => (
                <div key={index} className="p-3">
                  <div className="stepCard boxShadow p-4 pb-5">
        ...
        <div className="py-5">
          <div className="container ">
            ...
            <p className="large-text text-center mb-4">
            ...
            <div className="row pb-5">
              <Slider {...settings}> 
                  ...
                  <div className="p-3">
                    ...
                    >
                       <div className="d-flex justify-content-between align-items-center ">
                        <img src="/assets/card_comma.svg" className="cardComa"></img>
                        <div className="d-flex gap-1">
                          <img className="" src="/assets/white_star.svg" style={{height:"24px"}}></img>
                           <img className="" src="/assets/white_star.svg" style={{height:"24px"}}></img>
                            <img className="" src="/assets/white_star.svg" style={{height:"24px"}}></img>
                             <img className="" src="/assets/white_star.svg" style={{height:"24px"}}></img>
                              <img className="" src="/assets/white_star.svg" style={{height:"24px"}}></img>
                       ...
                       <h5 className="medium-bolder text-white mb-4 mt-5 pt-3">Life-Changing Care !</h5>
                       <p className="small-bold text-white mb-5 pb-5">After years of pain and failed diagnoses, ESSI finally gave me answers. The team listened, cared deeply, and changed my life completely.</p>
                       ...
                       <div className="d-flex align-items-center gap-3 "> 
                        <img src="/assets/homepage/Testi_review_1.png" className="reviewImg"></img>
                         <div>
                          ...
                          <p className="text-white mb-0" style={{fontSize:"14px" , fontWeight:"400"}}>Delhi, India</p>
                         </div>
                       </div>
                  ...
                  <div className="p-3 h-100">
                    ...
                    <img src="/assets/homepage/testimonial_card.png"></img>
                  </div>
                  ...
                  <div className="p-3">
                    ...
                    >
                       ...
                       <h5 className="medium-bolder text-white mb-4 mt-5 pt-3 ">Finally Understood !</h5>
                       <p className="small-bold text-white mb-5 pb-5">Every doctor dismissed my symptoms. ESSI took me seriously, explained everything clearly, and treated me like a person—not just a patient.</p>

                       <div className="d-flex align-items-center gap-3 "> 
                        <img src="/assets/homepage/Testi_review_3.png" className="reviewImg"></img>
                         <div>
                          <p className="para text-white mb-1">Gurleen Kaur</p>
                          <p className="text-white mb-0" style={{fontSize:"14px" , fontWeight:"400"}}>Punjab, India</p>
                         </div>
                       </div>
