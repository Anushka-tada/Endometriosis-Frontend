...
const EndometriosSteps = [
  ...
  {
    img: "/assets/homepage/Endometriosis_Infertility.png",
    title: "Adolescent Endometriosis",
    link: "/adolescent-endometriosis",
    subtitle: "Help with Complex Fertility Challenges",
  },
  {
    img: "/assets/homepage/Endometriosis_Infertility.png",
...
const page = () => {
  ...
  return (
    <>
      <Navbar/>
      <div className="pageOuter" style={{ backgroundColor: "rgba(250, 250, 250, 1)" }}>
