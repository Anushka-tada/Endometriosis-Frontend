        ...
        <div className="container">
          ...
          <div className="row align-items-center">
            <div className="col-md-6 col-12">
                 <p className="para mb-4">For individuals suffering from endometriosis, accessing high-quality, specialized care remains a significant challenge in many European countries. Despite the prevalence and debilitating nature of this disease, countless patients face barriers to receiving the care they need.</p>

                 <p className="para mb-4">At our world-class Endometriosis Center, we offer a solution to these barriers. We provide a comprehensive, patient-focused approach that prioritizes accurate diagnosis, advanced treatment, and personalized care.</p>

                 <p className="para mb-4">Located just one hour from most European destinations, our center eliminates the delays and compromises many face in their home countries. Our services include: expert diagnostics, minimally invasive excision surgery, a dedicated multidisciplinary team, and immediate access to specialized care.</p>
